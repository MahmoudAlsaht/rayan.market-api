...
router
    ...
    .post(upload.single('file'), (0, express_async_handler_1.default)(product_1.createProduct));
...
router
    ...
    .put(upload.single('file'), (0, express_async_handler_1.default)(product_1.updateProduct))
