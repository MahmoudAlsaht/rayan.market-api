...
router
    ...
    .post(upload.single('file'), (0, express_async_handler_1.default)(category_1.createCategory));
router
    .route('/:category_id')
    .get((0, express_async_handler_1.default)(category_1.getCategory))
    .put(upload.single('file'), (0, express_async_handler_1.default)(category_1.updateCategory))
